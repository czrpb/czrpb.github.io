...
### Foundations: Functions as Values
...
- Is a thing/type/object just like any other:
  - `int`
  - `str`
  - `class <NAME>`
- Is referenced by a name:
  - `def <NAME>`
...
To add or change behavior to an existing function without changing its implementation.
...
<!--
>>> raise_when_2nd_arg_is_0(1, 0)
Traceback (most recent call last):
  File "<python-input-12>", line 1, in <module>
    raise_when_2nd_arg_is_0(1, 0)
    ~~~~~~~~~~~~~~~~~~~~~~~^^^^^^
  File "<python-input-9>", line 3, in raise_when_2nd_arg_is_0
    raise ZeroIsAnInvalidArgument(
    ...<2 lines>...
    )
ZeroIsAnInvalidArgument: 0 is an invalid argument to the 2nd parameter.
-->
<!--
  Sort of, but:
    - Doesnt change the behavior of `x_div_y`
	  - Creates a new function
    - That new function has a pretty weird name
    - Hard-coded to `x_div_y`
-->
...
Traceback (most recent call last):
  File "<python-input-2>", line 1, in <module>
    x_div_y(1, 0)
    ~~~~~~~^^^^^^
  File "<python-input-1>", line 2, in x_div_y
    return x / y
           ~~^~~
...
Say I would like a specific exception:

```python
class ZeroIsAnInvalidArgument(Exception):
   pass
```
...
Traceback (most recent call last):
  File "<python-input-1>", line 1, in <module>
    x_div_y(1, 5)
    ~~~~~~~^^^^^^
  File "<python-input-0>", line 10,
       in raise_when_2nd_arg_is_0
    return x_div_y(p1, p2)
  File "<python-input-0>", line 10,
       in raise_when_2nd_arg_is_0
    return x_div_y(p1, p2)
...
Traceback (most recent call last):
  File "<python-input-3>", line 1, in <module>
    x_div_y(1, 0)
    ~~~~~~~^^^^^^
  File "<python-input-1>", line 4, in wrapper
    raise ZeroIsAnInvalidArgument(
    ...<2 lines>...
    )
ZeroIsAnInvalidArgument: 0 is an invalid
argument to the 2nd parameter.
```

</td><td>

```python
>>> list_with_item_repeated("A", 5)
['A', 'A', 'A', 'A', 'A']
